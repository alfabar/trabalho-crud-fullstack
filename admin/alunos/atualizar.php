...
<header class="sticky-top border-bottom border-dark">
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
      <h1 class="navbar-brand">Alunos | SELECT e UPDATE </h1>
...
<div class="container my-4">
    ...
    <form action="#" method="post">
	    ...
	    <p class="form-group">
	        ...
	        <input class="form-control" type="text" value="<?=$dados['situacao']?>" name="situacao" id="situacao"></input>
        </p>
